...
(updated 13-dic)
Coments:    Obtiene los tiempos de ejecucion del programa "rap.cpp"
            y los representa en una grafica.
@author:    Pablo Goitia <pgg566@alumnos.unican.es>


NOTES:      Requiere que el programa rap exista en el mismo directorio.
...
def exec_suma(threads):
    ...
    for i in range(NUM_MUESTRAS):
        ...
        call = './rap ' + str(NUM_ELEMENTS) + " " + str(threads + 1)
